...
#Comptage des calpha alignes et recup indice (= position dans pdb)
position1=[]
position2=[]
cpt=0
for i in range(0,len(l1),1):
	if l1[i] != "-" and l2[i] != "-":
		cpt+=1				
		position1.append(l1.index(l1[i]))
		position2.append(l2.index(l2[i]))
